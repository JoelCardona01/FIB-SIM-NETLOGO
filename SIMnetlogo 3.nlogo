        ...
        ifelse any? mammoths in-radius 5 and xmammoths = max-pxcor + 1 and ymammoths = max-pycor + 1[
          ...
          [
            if patch-here = patch xhome yhome and xmammoths != max-pxcor + 1 and ymammoths != max-pycor + 1 [
              ask humans with [rol > 50 and xhome = [xhome] of self and yhome = [yhome] of self] [face patch xhome yhome movehuman human-speed  set xmammoths  [xmammoths] of self  set ymammoths  [ymammoths] of self]
            ]
          ]
        ]
      ]
